define(	['backbone', 'underscore', 'handlebars', 'jquery',
				...
				'collection/reportMemos', 'bootstrap-table',
				'bootstrap-table-ench', 'jquery-cookie'], function(Backbone, _,
				Handlebars, $, slideSettingTemplate, ReportMemoCollection,
				BootstrapTable) {
			...
			var SlideSettingView = Backbone.View.extend({
				...
				alertSuccess : function() {
					...
					$(".alert.alert-success", this.$el).fadeTo(2000, 500)
							.slideUp(500, function() {
								$(".alert.alert-success", this.$el)
										.alert('close');
							});
				...
				saveChanges : function() {
					...
					// $(".alert.alert-success", this.$el).fadeTo(2000,
				...
				updateCheckStatus : function(event, rows) {
					...
					var ids2 = $.cookie(self.memoIdsCookieName2);
				...
				formatSnapShot : function(value) {
					...
					return '<img src="reportMemo.do?method=getImage&reportMemoId='
							+ value + '" class="file-preview-image">';
